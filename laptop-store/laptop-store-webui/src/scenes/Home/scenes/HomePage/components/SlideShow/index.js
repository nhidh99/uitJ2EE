...
class SlideShow extends Component {
            ...
            leftitems: [
                {
                    id: 1,
                    src:
                        "https://salt.tikicdn.com/cache/w885/ts/banner/d3/be/71/5ef563e60c6474802ae5fe8ae0b4f9ee.jpg",
                    title: "Picture 1",
                },
                {
                    id: 2,
                ...
                },
                {
                    id: 3,
                    src:
                        "https://salt.tikicdn.com/cache/w885/ts/banner/2e/e1/6d/a0c3e2bd0fa53ede55a3f9c2a30ee5e7.jpg",
                    title: "Picture 3",
                },
            ],
            rightitems: [
                {
                    id: 1,
                    src:
                        "https://salt.tikicdn.com/cache/w885/ts/banner/06/21/ac/b7872b67a058e3143d849233f75798c1.jpg",
                    title: "Picture 1",
                },
                {
                    id: 2,
    ...
    render() {
        ...
        let rightitems = this.state.rightitems.map((item) => {
            return <img src={item.src} key={item.id}></img>;
        });
