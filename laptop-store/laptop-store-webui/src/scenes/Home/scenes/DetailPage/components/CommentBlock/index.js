                ...
                <ListGroupItem>
                    <Row>
                        ...
                        <Col sm="10" className={styles.blockRight}>
                            ...
                            <p>
                                Laptop Lenovo Legion Y540-15IRH 81SY0037VN Core
                                i5-9300H/ GTX 1650 4GB/ Dos (15.6 FHD IPS) là
                                một cổ máy chơi game đáp ứng được cả hai nhu cầu
                                của người dùng: Thời thượng trong công việc và
                                mạnh mẽ để chơi game. Lenovo Y540 có một thiết
                                kế gọn gàng với khung nhôm chắc chắn, vỏ ngoài
                                màu xám sắt lạnh lùng và hệ thống chiếu sáng
                                xung quanh lên đến 16 triệu màu của công nghệ
                                CorSair ICUE, đã tạo ra một chiếc laptop gaming
                                thách thức mọi giới hạn và kì vọng của game thủ.
                            </p>
